...
test("Pages and Workers endpoints route prefixed WeatherKit requests to Apple", () => {
    const cases = [
        ...
        ["https://custom-project.pages.dev/weatherkit.apple.com/api/v1/weatherAlerts?ids=jianye-101190110", "weatherkit.apple.com/api/v1/weatherAlerts"],
        ["https://custom.example/weatherkit.apple.com/api/v1/weatherAlerts?ids=jianye-101190110", "weatherkit.apple.com/api/v1/weatherAlerts"],
    ];
